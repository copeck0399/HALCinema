...
<div class="content">
	...
	<section>
		...
		<p class="ptitle"><img src="img/warning.png" width="14" height="14" alt="icon" />退会後、新規登録することが可能です。</p><br>
	</section>

      <form class="formbox" name="Form1" method="post" action="delete_complete.php">
			<div class="form">
        <table>
          <tr>
						<th>パスワード</th>

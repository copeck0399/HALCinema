...
<html lang="ja">
	<head>
		...
		<link rel="stylesheet" href="css/memberinfo.css" media="screen" title="css">
		<title>◯会員情報変更</title>
	</head>
	<body>
<?php
      ...
      <form name="Form1" method="post" action="exit_comfirm.php">
        ...
        <table>
          <tr>
            <th>氏名（漢字）</th>
            <td>
              性<input type="text" class="tbox" name="name1" value="">名<input type="text" class="tbox" name="name2" value="">
							</td>
								<td>
									<p class="righttext">
									｜　例 ： 山田　太郎
					...
					<tr>
						<th>氏名（カナ）</th>
						<td>
							性<input type="text" class="tbox" name="name3" value="">名<input type="text" class="tbox" name="name4" value="">
							</td>
								<td>
									<p class="righttext">
									｜　例 ： ヤマダ　タロウ
